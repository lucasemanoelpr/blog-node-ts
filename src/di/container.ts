...
import PasswordResetController from '#presentation/http/controllers/authentication/ResetPasswordController'
...
childContainer.registerSingleton(tokens.PasswordResetController, PasswordResetController)
